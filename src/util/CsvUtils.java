    ...
    public static List<Juego> deCsvAList(String fichero) throws CsvException {
        ...
        try (Reader reader = new FileReader(fichero);
            ...
            for (CSVRecord csvRecord : csvParser) {
                ...
                lista.add(
                        new Juego(
                                Integer.parseInt(csvRecord.get(0)), // ranking
            ...
            LOGGER.log(Level.SEVERE, "Error obteniendo datos del fichero csv", e);
            throw new CsvException("Error obteniendo datos del fichero csv", e);

        } catch (NumberFormatException e) {
            LOGGER.log(Level.SEVERE, "Error parseando datos en las columnas del csv a atributos de Juego", e);
