...
public class DAOJuegosImpl implements DAOJuegos {
     ...
     *
     * @param juegoCompara Recive un juego de parametro para comprovar su existencia
     ...
     * @param listaEditor Lista de editores
     * @param listaPlataforma Lista de plataformas
     */
     ...
     *
     * @param listaEditor Objeto lista de editores que encapsula el conjunto con editores
     */
     ...
     *
     * @param listaPlataforma Objeto listaPlataforma que contiene el conjunto de plataformas
     */
